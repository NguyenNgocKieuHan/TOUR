/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     9/11/2024 3:00:27 PM                         */
/*==============================================================*/
...
alter table BOOKING add constraint FK_BOOKING foreign key (TOURID)
      references TOUR (TOURID) on delete restrict on update restrict;

alter table BOOKING add constraint FK_BOOKING2 foreign key (USERID)
